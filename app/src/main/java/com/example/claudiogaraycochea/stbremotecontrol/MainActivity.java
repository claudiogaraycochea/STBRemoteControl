package com.example.claudiogaraycochea.stbremotecontrol;
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            case 1:
                ...
                openURL("synchro/index.html");
                break;
            case 2:
                mTitle = getString(R.string.title_section2);
                openURL("control/joystick/index.html");
                break;
            case 3:
                mTitle = getString(R.string.title_section3);
                openURL("control/tv/index.html");
                break;
            case 4:
                mTitle = getString(R.string.title_section4);
                openURL("control/video/index.html");
                break;
            case 5:
